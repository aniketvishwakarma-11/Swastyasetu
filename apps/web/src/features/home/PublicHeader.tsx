    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center space-x-2.5 group cursor-pointer">
          <div className="w-8 h-8 rounded-lg bg-teal-600 text-white flex items-center justify-center shadow-sm shadow-teal-600/20 group-hover:bg-teal-700 transition-colors">
            <Activity className="w-4 h-4" />
          </div>
          <div>
            <span className="text-sm font-bold text-slate-900">SwasthyaSetu</span>
            <span className="hidden sm:inline ml-2 text-[10px] font-semibold text-teal-700 bg-teal-50 border border-teal-200 rounded px-1.5 py-0.5">
              Continuity Layer
            </span>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center space-x-1 text-xs font-medium text-slate-600" aria-label="Page sections">
          <a
            href="#how-it-works"
        ...
        <div className="flex items-center space-x-2">
          {user ? (
            <>
              <Link
                to={dashboardRoute}
                className="flex items-center space-x-1.5 px-3 py-1.5 text-xs font-semibold text-white bg-teal-600 rounded-lg hover:bg-teal-700 transition-colors shadow-sm cursor-pointer"
              >
