        ...
        <div className="flex items-center space-x-2">
          {user ? (
            ...
            <div className="hidden sm:flex items-center space-x-2">
              ...
              <Link
                to="/signup"
                className="flex items-center space-x-1.5 rounded-lg bg-teal-600 px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-teal-700 cursor-pointer"
              >
